...
public class Player extends Entity{
    ...
    public int numOfMonKilled[] = {0,0,0};
    ...
    public Player(GamePanel gp, KeyHandler keyH, int currentPlayer){
        ...
        setDefaultValues(currentPlayer);
        getPlayerImage();
        getPlayerAttackImage();
        setItem();
    }    
    public void setDefaultValues(int currenPlayer){
    	...
    	if(i!=999) {
    		if(gp.monster[gp.currentMap][i].invincible == false) {
    			...
    			if(gp.monster[gp.currentMap][i].life<=0) { 
    				...
    				if(gp.aSetter.numOfCurrentMonster[gp.currentMap]==0) {
